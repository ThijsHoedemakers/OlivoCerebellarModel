...
for ii in range(0, N_Cells_IO, 1):
    IO_Coupled_STDP.V_Na[ii] = IO_V_Na
    IO_Coupled_STDP.V_K[ii] = IO_V_K
    IO_Coupled_STDP.V_Ca[ii] = IO_V_Ca
    IO_Coupled_STDP.V_l[ii] = IO_V_l
    IO_Coupled_STDP.V_h[ii] = IO_V_h
    IO_Coupled_STDP.Cm[ii] = IO_Cm 
    IO_Coupled_STDP.g_Na[ii] = IO_g_Na
    IO_Coupled_STDP.g_Kdr[ii] = IO_g_Kdr
    IO_Coupled_STDP.g_K_s[ii] = IO_g_K_s
    IO_Coupled_STDP.g_h[ii] = IO_g_h
    IO_Coupled_STDP.g_Ca_h[ii] = IO_g_Ca_h
    IO_Coupled_STDP.g_K_Ca[ii] = IO_g_K_Ca
    IO_Coupled_STDP.g_Na_a[ii] = IO_g_Na_a
    IO_Coupled_STDP.g_K_a[ii] = IO_g_K_a
    IO_Coupled_STDP.g_ls[ii] = IO_g_ls
    IO_Coupled_STDP.g_ld[ii] = IO_g_ld
    IO_Coupled_STDP.g_la[ii] = IO_g_la
    IO_Coupled_STDP.g_int[ii] = IO_g_int
    IO_Coupled_STDP.p[ii] = IO_p
    IO_Coupled_STDP.p2[ii] = IO_p2
    IO_Coupled_STDP.g_Ca_l[ii] =  IO_g_Ca_l
    IO_Coupled_STDP.a_value[ii] = 0*metre**-2*amp
...
for jj in range(0,N_Cells_PC,1):
    PC_Uncoupled_STDP.C[jj] = PC_C
    PC_Uncoupled_STDP.gL[jj] = PC_gL
    PC_Uncoupled_STDP.EL[jj] = PC_EL
    PC_Uncoupled_STDP.VT[jj] = PC_VT
    PC_Uncoupled_STDP.DeltaT[jj] = PC_DeltaT
    PC_Uncoupled_STDP.Vcut[jj] = PC_Uncoupled_STDP.VT[jj]+ 5*PC_Uncoupled_STDP.DeltaT[jj]
    PC_Uncoupled_STDP.tauw[jj] = PC_tauw
    PC_Uncoupled_STDP.a[jj] = PC_a
    PC_Uncoupled_STDP.b[jj] = PC_b
    PC_Uncoupled_STDP.Vr[jj] = PC_Vr
    PC_Uncoupled_STDP.v[jj] = PC_v
    PC_Uncoupled_STDP.I_intrinsic[jj] = PC_I_intrinsic
    #PC_I_intrinsic[jj]
...
for ii in range(0, N_Cells_IO, 1):
    IO_Uncoupled_STDP.V_Na[ii] = IO_V_Na
    IO_Uncoupled_STDP.V_K[ii] = IO_V_K
    IO_Uncoupled_STDP.V_Ca[ii] = IO_V_Ca
    IO_Uncoupled_STDP.V_l[ii] = IO_V_l
    IO_Uncoupled_STDP.V_h[ii] = IO_V_h
    IO_Uncoupled_STDP.Cm[ii] = IO_Cm 
    IO_Uncoupled_STDP.g_Na[ii] = IO_g_Na
    IO_Uncoupled_STDP.g_Kdr[ii] = IO_g_Kdr
    IO_Uncoupled_STDP.g_K_s[ii] = IO_g_K_s
    IO_Uncoupled_STDP.g_h[ii] = IO_g_h
    IO_Uncoupled_STDP.g_Ca_h[ii] = IO_g_Ca_h
    IO_Uncoupled_STDP.g_K_Ca[ii] = IO_g_K_Ca
    IO_Uncoupled_STDP.g_Na_a[ii] = IO_g_Na_a
    IO_Uncoupled_STDP.g_K_a[ii] = IO_g_K_a
    IO_Uncoupled_STDP.g_ls[ii] = IO_g_ls
    IO_Uncoupled_STDP.g_ld[ii] = IO_g_ld
    IO_Uncoupled_STDP.g_la[ii] = IO_g_la
    IO_Uncoupled_STDP.g_int[ii] = IO_g_int
    IO_Uncoupled_STDP.p[ii] = IO_p
    IO_Uncoupled_STDP.p2[ii] = IO_p2
    IO_Uncoupled_STDP.g_Ca_l[ii] =  IO_g_Ca_l
...
for dd in range(0,N_Cells_DCN,1):    
    DCN_Uncoupled_STDP.C[dd] = DCN_C
    DCN_Uncoupled_STDP.gL[dd] = DCN_gL
    DCN_Uncoupled_STDP.EL[dd] = DCN_EL
    DCN_Uncoupled_STDP.VT[dd] = DCN_VT
    DCN_Uncoupled_STDP.DeltaT[dd] = DCN_DeltaT
    DCN_Uncoupled_STDP.Vcut[dd] = DCN_Uncoupled_STDP.VT[dd] + 5*DCN_Uncoupled_STDP.DeltaT[dd]
    DCN_Uncoupled_STDP.tauw[dd] = DCN_tauw
    DCN_Uncoupled_STDP.a[dd] = DCN_a
    DCN_Uncoupled_STDP.b[dd] = DCN_b
    DCN_Uncoupled_STDP.Vr[dd] = DCN_Vr
    DCN_Uncoupled_STDP.tauI[dd] = DCN_tauI
    DCN_Uncoupled_STDP.I_PC_max[dd] = DCN_I_PC_max
    DCN_Uncoupled_STDP.v[dd] = DCN_v
    DCN_Uncoupled_STDP.I_intrinsic[dd] = DCN_I_intrinsic
######### Monitors ###############
